...
public class PaymentsController {
    ...
    @PostMapping("/check-payment-completed")
    public ClientResponse checkIfPaymentCompleted(@Valid @RequestBody CreateRentalPaymentRequest request){
        return service.checkIfPaymentCompleted(request);
    }
