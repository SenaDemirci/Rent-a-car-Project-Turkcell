...
public class InventoryConsumer {
    ...
    public void consumer(CarCreatedEvent event) {
    ...
    public void consumer(CarDeletedEvent event) {
    ...
    public void consumer(BrandDeletedEvent event){
        service.deleteAllByBrandId(event.getBrandId());
        log.info("Brand all deleted event consumed {}", event);
    }
    @KafkaListener(
            topics = "model-deleted",
            groupId = "model-delete"
    )
    public void consumer(ModelDeletedEvent event){
        service.deleteAllByModelId(event.getModelId());
        log.info("Model all deleted event consumed {}", event);
