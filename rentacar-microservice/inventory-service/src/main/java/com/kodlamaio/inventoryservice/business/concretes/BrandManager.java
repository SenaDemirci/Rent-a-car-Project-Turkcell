...
public class BrandManager implements BrandService {
    ...
    public List<GetAllBrandsResponse> getAll() {
        ...
        var responses=brands.stream()
                .map(brand ->mapper.forResponse().map(brand,GetAllBrandsResponse.class)).collect(Collectors.toList());
    ...
    public void delete(UUID id) {
        ...
        sendKafkaBrandDeletedMessage(id);

    }

    private void sendKafkaBrandDeletedMessage(UUID id) {
